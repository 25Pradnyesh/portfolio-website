    ...
    <Panel id={ID}>
      ...
      <PanelContent className="space-y-6">
        <p className="max-w-xl text-sm/relaxed text-pretty text-muted-foreground">
          ...
          open-source software, and engineering opportunities. If you are
          working on something exciting or want to collaborate, feel free to
          reach out directly.
        </p>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <Button
            ...
            render={
              <a
                href={SOCIAL.cal.href}
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Schedule a call on Cal.com"
              >
