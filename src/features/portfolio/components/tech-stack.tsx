                    ...
                    return (
                      <li key={item.key} className="flex">
                        <a
                          ...
                          className="flex h-(--badge-height) items-center justify-center gap-1.25 rounded-full bg-zinc-50/80 px-2.5 font-mono text-xs text-foreground inset-ring-1 inset-ring-border transition-all hover:scale-[1.02] hover:bg-zinc-100 focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-none dark:bg-zinc-900/80 dark:hover:bg-zinc-800 [&_svg]:pointer-events-none [&_svg]:size-3.5 [&_svg]:shrink-0 [&_svg]:text-muted-foreground/80"
                        >
                          {item.icon}
                          {item.title}
                        </a>
