        ...
        <div className="flex w-full translate-y-[37.5%] items-center justify-center">
          ...
          >
            <text
              ...
              y="75%"
              textAnchor="middle"
              className="font-heading text-[160px] font-black tracking-widest uppercase select-none"
            ...
            <text
              ...
              y="75%"
              textAnchor="middle"
              className="stroke-foreground/10 font-heading text-[160px] font-black tracking-widest uppercase select-none"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
            >
